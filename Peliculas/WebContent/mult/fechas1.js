...
*    function diasEntreFechas(dia,mes,anno)
...
*  dia, mes y año
*  
* Comprueba la diferencia de dias entre la fecha dada y la actual
*/
function diasEntreFechas(dia,mes,anno) {
     var devuelto=1;
     var hoy=new Date();
   ...
   while ( devuelto<27)
   { 
	var fecha_i_real = fechaRestaDias( parseInt(dia), parseInt(mes), parseInt(anno), parseInt(devuelto));
	
	var fecha_i_comp = (parseInt(hoy.getFullYear())*10000) + (parseInt(hoy.getMonth()+1)*100) + parseInt(hoy.getDate());
