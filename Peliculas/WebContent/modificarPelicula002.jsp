...
function volver()
{
	document.formulario.action = "PeliculasServlet?accion=volverModificarPelicula";
	document.formulario.submit();
}
-->
</script><title></title>
...
<body>
<form name="formulario" method="post" action="PeliculasServlet?accion=confirmarModificarPelicula">
...
<input type="button" name="Aceptar" value="Modificar" class="boton" onclick="continuar()">
</center>
</form>
</body>
</html>