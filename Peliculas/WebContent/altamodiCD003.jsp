...
function continuar()
{
	...
	{
		document.formulario.action="CDServlet?accion=confirmarModificarCD";
	}
...
<body>
<form name="formulario" method="post" action="CDServlet?accion=confirmarAltaCD">
...
<%	
	...
	Vector vNuevas = (Vector) request.getSession().getAttribute("listaPeliculasCDNuevas");
	int i=0;
