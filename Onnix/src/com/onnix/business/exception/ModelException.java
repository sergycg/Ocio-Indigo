...
public class ModelException extends Exception {
	 ...
	 */
	public ModelException(String msgKey) {
		super();
		rootCause = null;
		this.msgKey = msgKey;
	}
	 ...
	 */
	public ModelException(String mensaje, boolean personalizado) {
		super();
		rootCause = null;
	 ...
	 */
	public ModelException(Throwable rootCause) {
	 ...
	 *            excepci&oacute;n lanzada.
	 */
	public ModelException(String msgKey, Throwable rootCause) {
		super();
		this.rootCause = rootCause;
		this.msgKey = msgKey;
	}
