...
%>
	<tr>
		<td class="cabeceratitulo" ><a href="PeliculasServlet?accion=listarPeliculasTodas"><p class="titulotabla">Num</p></a></td>
		<td class="cabeceratitulo" ><a href="PeliculasServlet?accion=listarPeliculasTodas&orden=titulo"><p class="titulotabla">Titulo</p></a></td>
		<td class="cabeceratitulo" ><a href="PeliculasServlet?accion=listarPeliculasTodas&orden=formato"><p class="titulotabla">Formato</p></a></td>
		<td class="cabeceratitulo" ><a href="PeliculasServlet?accion=listarPeliculasTodas&orden=idcd"><p class="titulotabla">Id CD</p></a></td>
		<td class="cabeceratitulo" ><a href="PeliculasServlet?accion=listarPeliculasTodas&orden=iddvd"><p class="titulotabla">Id DVD</p></a></td>
...
%>
	<tr>
		...
		<td class="<%=fila%>" ><p class="dato"><a href="PeliculasServlet?accion=consultarPelicula&num=<%=peli.getNumero() %>&orig=listar"><img src="mult/consulta.gif" border="0" alt="Consultar"></a></p></td>
		...
		<td class="<%=fila%>" ><p class="dato"><a href="PeliculasServlet?accion=eliminarPelicula&num=<%=peli.getNumero() %>"><img src="mult/eliminar.gif" border="0" alt="Eliminar"></a></p></td>
   	</tr>
<%
		i++;
	}
