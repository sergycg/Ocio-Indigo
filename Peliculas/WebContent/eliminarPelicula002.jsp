...
<table border="0" cellpadding="2" cellspacing="1" width="500" align="center">
     <tr>
          <td class="cabeceratitulo" colspan="5"><p class="titulotabla">Eliminar película</p></td>
     </tr>
	<tr>
		<td class="cabecera2" ><p class="textablacabecera">La película se ha eliminado corectamente.</p></td>
	</tr>
</table>
<%
