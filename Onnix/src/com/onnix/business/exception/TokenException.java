...
public class TokenException extends Exception{
	 ...
	 */
	public TokenException(String msgKey) {
		super();
		rootCause = null;
		this.msgKey = msgKey;
	}
	 ...
	 */
	public TokenException(String mensaje, boolean personalizado) {
		super();
		rootCause = null;
	 ...
	 */
	public TokenException(Throwable rootCause) {
	 ...
	 *            excepci&oacute;n lanzada.
	 */
	public TokenException(String msgKey, Throwable rootCause) {
		super();
		this.rootCause = rootCause;
		this.msgKey = msgKey;
	}
