...
public class ViewPendientesPagoBean {
	...
	public static ViewPendientesPagoBean populate(ViewPendientesPagoVO vo){
		ViewPendientesPagoBean bean = new ViewPendientesPagoBean();
