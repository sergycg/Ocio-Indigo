...
jQuery(document).ready(function(){
	...
	var validator = validarFormulario("derechoDISForm");
	 ...
	 */
	comprobarCambiosGenerales("datosGeneralesDerecho", "derechoDISForm");
	...
	var entrada = {
			...
			formulario : jQuery("#derechoDISForm")
	};
