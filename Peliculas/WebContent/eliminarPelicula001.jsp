...
function cancelar()
{
	...
	else if (origen=="altaCD")
	{
		document.formulario.action="CDServlet?accion=volverAltaCD";
		document.formulario.submit();
	}
	else if (origen=="consultaCD")
	{
		document.formulario.action="CDServlet?accion=volverModificarCD";
		document.formulario.submit();
	}
	else
		document.location.href="PeliculasServlet?accion=listarPeliculasTodas";
}
...
<body>
<form name="formulario" method="post" action="PeliculasServlet?accion=confirmarEliminarPelicula">
...
<br>
<center>
<input type="hidden" name="num" value="<%=p.getNumero() %>">
<input type="button" name="Eliminar" value="Eliminar" class="boton" onclick="continuar()">
