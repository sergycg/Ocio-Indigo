...
<body>
<form name="formulario" method="post" action="modificarPelicula002.jsp">
...
<table border="0" cellpadding="0" cellspacing="0"  align="center">
     ...
     <tr>
		...
		-->
		<td class="fondotitular"><font class="texttitular">Modificar Película </font></td>
	...
	<tr>
		...
		<% 
			...
			for(int i=0;e.hasMoreElements();i++)
			{
				...
				if (request.getParameter("formato").equals(formato.getFormato()))
				{
				%>
					<option value="<%=formato.getFormato()%>" selected><%=formato.getFormato()%></option> 
				<%
				}
				else
				{
