...
function cancelar()
{
	document.formulario.action="CDServlet?accion=listarCDsTodos";
	document.formulario.submit();
}
...
<body>
<form name="formulario" method="post" action="CDServlet?accion=confirmarEliminarCD">
...
<table border="0" cellpadding="0" cellspacing="0"  align="center">
     ...
     <tr>
		...
		-->
		<td class="fondotitular"><font class="texttitular">Eliminar CD </font></td>
